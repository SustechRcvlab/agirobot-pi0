...
def main(config: _config.TrainConfig):
    ...
    # print(f"当前使用加载数据的进程数为: {config.num_workers}")
...
if __name__ == "__main__":
    main(_config.cli())
# XLA_PYTHON_CLIENT_MEM_FRACTION=0.9 uv run examples/test_train.py pi0_base_agibot_lora --exp-name=my_experiment --overwrite
#
